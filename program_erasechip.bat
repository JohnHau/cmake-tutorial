...
REM echo ********************** Receive factory image... **********************
REM blhost.exe -u 0x15A2,0x0073 -t 3000000 -- receive-sb-file factory_image.sb

REM echo ********************** Receive factory config... **********************
REM blhost.exe -u 0x15A2,0x0073 -t 3000000 -- receive-sb-file factory_config.sb 
